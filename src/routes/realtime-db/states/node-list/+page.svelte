...
<section>
	<div class="container flex flex-col gap-8 py-8 lg:py-16 xl:py-24">
		...
		<ul class="flex max-w-prose flex-col gap-4">
			...
			<li>
				<code>ref: string | DatabaseReference</code> - The database node list reference to create
		...
		<ul class="flex max-w-prose flex-col gap-4">
			...
			<li>
				<code>key: string</code> - The node list key
			</li>
			<li>
				<code>loading: boolean</code> - If the node list is loading (undefined)
			</li>
			<li>
