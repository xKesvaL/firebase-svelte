<script>
	...
	const title = `Collection Store | Firebase Svelte`;
	const description = `The collection store is a store that holds the data of a collection.`;
	const url = `https://firebase-svelte.vercel.app/firestore/stores/collection`;
	const image = ``;
</script>
