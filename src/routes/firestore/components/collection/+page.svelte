<script>
	...
	const url = `https://firebase-svelte.vercel.app/firestore/components/collection`;
	const image = ``;
</script>
...
<section>
	<div class="container flex flex-col gap-8 py-8 lg:py-16 xl:py-24">
		<h1 id="collection" class="font-mono text-4xl font-black lg:text-5xl">&lt;Collection&gt;</h1>
		...
		<ul class="flex max-w-prose flex-col gap-4">
			...
			<li>
				<code>ref: string | CollectionReference&lt;Data[]&gt;</code> - The collection reference to
				create the store from. Can be a string, just like <code>posts</code> or a
		...
		<div class="flex flex-col gap-4">
			...
			<ul class="flex max-w-prose flex-col gap-2">
				...
				<li>
					<code>ref: CollectionReference&lt;Data[]&gt; | null</code> - The collection reference you gave.
				</li>
				<li>
				...
				<li>
					<code>first: Data | null</code> - The first document in the collection.
				</li>
				<li>
					<code>last: Data | null</code> - The last document in the collection.
				</li>
			</ul>
		</div>
		<div class="flex flex-col gap-4">
