<script>
	...
	const url = `https://firebase-svelte.vercel.app/storage/components/download-url`;
	const image = ``;
</script>
...
<section>
	<div class="container flex flex-col gap-8 py-8 lg:py-16 xl:py-24">
		<h1 id="download-url" class="font-mono text-4xl font-black lg:text-5xl">&lt;DownloadUrl&gt;</h1>
		...
		<div class="flex flex-col gap-4">
			...
			<ul class="flex max-w-prose flex-col gap-2">
				<li>
					<code>link: string | null</code> - The link to the file.
				</li>
				<li>
